...
/**
 * Placeholder loader for future Specter-supported inputs.
 */
public class SpecterLoader extends AbstractProgramWrapperLoader {
	...
	public List<Option> getDefaultOptions(ByteProvider provider, LoadSpec loadSpec,
		...
		list.add(new Option("Specter loader mode", "default"));
