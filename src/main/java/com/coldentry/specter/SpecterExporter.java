...
/**
 * Placeholder exporter for future Specter output formats.
 */
public class SpecterExporter extends Exporter {

	/**
	 * Exporter constructor.
	 */
	public SpecterExporter() {

		// Name the exporter and associate a file extension with it

		super("Specter Exporter", "specter", null);
	}
	...
	public List<Option> getOptions(DomainObjectService domainObjectService) {
		...
		list.add(new Option("Specter export mode", "default"));
